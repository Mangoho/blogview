<template>
  <div
    style="border: 1px dashed #515a6e;border-radius: 4px;padding: 4px 10px 4px 4px;display: inline-block; position:relative;"
  >
    <!--展示所有已上传图片-->
      ...
      <template>
        ...
        <div class="demo-upload-list-cover">
          ...
          <Icon
            ...
            @click.native="handleView(item.name, index)"
          ></Icon>
		  <!--删除图片-->
          <Icon
