...
const routes = [
  {
    ...
    children: [
	  ...
	  /*
      {
        path: "view",
        name: "UnloginContent",
        component: () => import("../views/UnloginContent.vue")
      },
	  */
      {
        path: "general",
      ...
      },
      {
        path: "myweibo",
        name: "myweibo",
        component: () => import(/* webpackChunkName: "about" */ "../views/myweibo.vue")
      },
      {
        path: "regist",
        name: "Register",
      ...
      },
      {
        path: "myfocus",
        name: "myfocus",
        component: () => import(/* webpackChunkName: "about" */ "../views/myfocus.vue")
      }
    ]
  }
];
